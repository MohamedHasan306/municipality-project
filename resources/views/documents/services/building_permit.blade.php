...
<head>
    ...
    <style>
        ...
        /*
         * Arabic / RTL text only.
         * We do NOT apply RTL to the whole document
         * so the existing layout remains unchanged.
         */
        .rtl-text {
            direction: rtl;
            text-align: right;
...
<table class="data-table">
    ...
    @foreach ($fields as $field)
        ...
        @php
            ...
            /*
             * Resolve the value of the dynamic field.
             *
             * File fields use the uploaded attachment original name.
             * Other fields use the dynamic data stored in data_json.
             */
             ...
             * U+0600 - U+06FF
             *
             * This allows English values, numbers and codes
             * to keep the existing LTR layout.
             */
            $isArabic = is_string($value)
                && preg_match('/[\x{0600}-\x{06FF}]/u', $value);
    ...
    <table class="signature-table">
        ...
        <tr>
            ...
            <td>
                ...
                <span class="{{ preg_match('/[\x{0600}-\x{06FF}]/u', (string) $mayor->full_name) ? 'rtl-text' : '' }}">
                    {{ $mayor->full_name }}
                </span>
